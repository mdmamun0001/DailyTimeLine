...
return [
    ...
    'routes' => [
        ...
        */
        ...
        'middleware' => [
            'api' => [],
            'asset' => [],
            'docs' => [App\Http\Middleware\BasicAuthenticate::class],
            'oauth2_callback' => [],
        ],
    ],
    ...
    */
	...
	'bearerAuth' => [ // Unique name of security
            ...
            'description' => 'Enter your bearer token in the value field, first type Bearer then give speace then put the token',
